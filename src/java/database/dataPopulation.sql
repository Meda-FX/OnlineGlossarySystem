...
VALUES
    ('0','password','0','John Johnson','johnjohnson@gmail.com', 01);

INSERT INTO [user] 
    (user_id, password, department_id, [name], email, activated)
VALUES
    ('1','password','0','Bob Bobson','bobBobson@gmail.com', 01);
...
INSERT INTO definition 
    (definition_uid,glossary_entry,definition, date_created,citation,made_by,course_id,[type])
VALUES
