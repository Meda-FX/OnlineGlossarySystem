...
/**
 * GlossaryEntryService class uses to access data from the database by utilizing
 * the GlossaryEntryBroker.
 *
...
public class GlossaryEntryService {
    ...
    /**
     * Constructs a glossary entry object to be used as a service to the
     * glossary entry DB
     */
     ...
     * @return return a glossary entry object if the term exists and null if the
     * term does not exist
     */
    ...
    /**
     * Method used to update the glossary entry. If the entry is updated
     * successfully the return type will be 1 or if the entry is not a success
     * it will return 0.
     *
     * @param glossaryEntry glossaryEntry the specific glossary entry used to
     * update
     * @return returns 1 if the update is a success and 0 if the update is un
     * successful
     */
    ...
    /**
     * Method used to delete the glossary entry. If the entry is deleted
     * successfully the return type will be 1 or if the entry is not a success
     * it will return 0.
     *
     * @param glossaryEntry glossaryEntry the glossary entry used to delete the
     * entry
     * @return returns 1 if the deletion is a success and 0 if the deletion is
     * un successful
     */
    ...
    /**
     * Method used to insert in to the glossary entry system. If the insertion
     * is successful the return type will be 1 or if the insertion is not a
     * success it will return 0.
     *
     * @param glossaryEntry glossaryEntry the glossary entry used to insert the
     * entry to the system
     * @return returns 1 if the insertion is a success and 0 if the insertion is
     * un successful
     */
    ...
    /**
     * getMatched method used to get all partially matched terms
     *
     * @param term needs to search
    ...
    /**
     * getByAlpha method used to a list of terms starts with a letter
     *
     * @param letter the range is between A~Z
     * @return a list of entries
     */
    ...
    /**
     * checkTerm method is to check if the term exist if not insert it to
     * database
     *
     * @param ge the term needs to check
     */
