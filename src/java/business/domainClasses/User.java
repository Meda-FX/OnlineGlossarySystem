...
/**
 * User class constructs the user object it allowed mutation and accessing of
...
public class User {
    ...
    /**
     * Default constructor of user obect
     */
    public User() {
     ...
     * @param privileges the privilege given by the administrator if the
     * glossary system manager
    ...
    /**
     * The method will return the privilege list. The privilege refers to the
     * users access in the system
     *
    ...
    /**
     * The setIsActivated method is set the active status for a user
     *
     * @param isActivated the active status to set
     */
    ...
    /**
     * The getIsActivated method will return the active status of the
     * users
     *
